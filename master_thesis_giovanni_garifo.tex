...
vector) of the node \emph{i}, $W_0$ is the learnt parameter vector for the
...
the graph. $W_r$ is the vector of learnt parameters for the relation $r$.
...
transformed in a diagonal matrix $R_r\in\mathbb{R}^{d \times d}$, it computes
an associated score as a real value:
