...
% in questo capitolo devo introdurre la pipeline e spiegare ad alto livello
% ogni blocco cosa fa, spiegherò COME è stato fatto nell'implementazione (e con
% quali tool)
% posso citare alcuni paper che implementano il MessagePassingFramework (vedi video)
