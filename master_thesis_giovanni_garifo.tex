...
words are used in similar contexes. This can led to new scenarios for
...
the input data.
An example of one of the most succesful applications of DL is in
...
node $i$, which are now passing the informations of their surrounding to it.
